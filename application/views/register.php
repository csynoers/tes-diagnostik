...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url() ?>"><b>Tes</b> Diagnostik</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?php echo base_url('auth/store'); ?>" method="post">
        <div class="input-group mb-3">
          <input name="nik" type="text" class="form-control" placeholder="NISN" required="" autocomplete="on">
        ...
        <div class="input-group mb-3">
          ...
          <input name="birth_date" type="date" class="form-control" placeholder="Nama lengkap" required="" autocomplete="on">
        </div>
        <div class="input-group mb-3">
