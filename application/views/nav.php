    ...
    <div class="navbar-nav ml-auto">
      <?php
        if( $this->session->userdata('user') )
        {
          ...
          echo '<a href="'.base_url('auth/logout').'" class="btn btn-default" onclick="return confirm(`Apakah anda yakin akan keluar`)">Logout</a>';
        }
      ?>
          ...
          <?php
            if( $this->session->userdata('user') )
            {
              echo '
                ...
                <li class="nav-item ">
                  <a href="'.base_url('auth/logout').'" class="nav-link" onclick="return confirm(`Apakah anda yakin akan keluar`)">
